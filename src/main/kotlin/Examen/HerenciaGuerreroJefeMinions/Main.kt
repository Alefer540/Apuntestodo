package Examen.HerenciaGuerreroJefeMinions

import kotlin.random.Random

fun main() {
    //El padre debe transformar en abstracto, indicando que tiene funciones que sus hijos deben implementar abstract:
    //abstract class ClasePadre {
    //   val atributoPadre = 1
    //   abstract fun funAbstracta()
    //}
    //Esto tendrá algunas consecuencias:
    //El hijo obligatoriamente deberá tener una función override fun funAbstracta() {}
    //Ya no se podrán objetos de la clase padre.

    //El hijo debe implementar las funciones abstractas del padre abstract:
    //class ClaseHija : ClasePadre() {
    //   val atributoHijo = 2
    //   override fun funAbstracta() { println("Esto es una función abstracta")}
    //}
    //
    //Esto tendrá algunas consecuencias:
